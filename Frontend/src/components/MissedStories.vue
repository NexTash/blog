			...
			>
				...
				>
					...
					<router-link :to="{ name: 'PostDetail', params: { name: post.name } }">
						<h3
							class="mt-3 line-clamp-2 text-lg font-black leading-snug text-gray-900 transition-colors group-hover:text-[#b42318]"
						>
							{{ post.title }}
						</h3>
					</router-link>
					...
					<div
						class="mt-4 text-[11px] font-bold uppercase tracking-[0.14em] text-gray-400"
					>
						{{
